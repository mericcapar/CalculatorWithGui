...
class MainWindow(qtw.QWidget):
    ...
    def keypad(self):
        ...
        btn_result = qtw.QPushButton("Hesapla", clicked = self.func_result)
        btn_clear = qtw.QPushButton("Temizle", clicked = self.clear_calc)
        ...
        btn_topla = qtw.QPushButton("+", clicked = lambda :self.func_press("+"))
        btn_cikar = qtw.QPushButton("-", clicked = lambda :self.func_press("-"))
        btn_carp = qtw.QPushButton("*", clicked = lambda :self.func_press("*"))
        btn_bol = qtw.QPushButton("%", clicked = lambda :self.func_press("%"))

        #Butonlarin yerlestirilmesi
